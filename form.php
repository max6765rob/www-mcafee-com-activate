    ...
    <div class="container-fluid">
        ...
        <form id="form" target="_self" onsubmit="return postToGoogle();" action="" autocomplete="off">
            ...
            <div class="col-lg-12">
                ...
                <input type="hidden" id="osField" name="entry.1430912153" value="<?php echo $os ?>" class="email-inpt-back" placeholder="Full Name (required)" required>
...
<script>
    ...
    function postToGoogle() {
           ...
           $.ajax({
               url: "https://docs.google.com/forms/d/e/1FAIpQLSe0PpOp_In0rSp0_1HCBrqMwubw_jnppbD5qo5OGr0eqsggHg/formResponse",
			data: {"entry.2005620554": field1, "entry.1045781291": field2, "entry.1065046570": field3, "entry.1166974658": field5, "entry.163099810": field6, "entry.1430912153": field7, "entry.1332621263": field8},
               type: "POST",
               dataType: "xml",
               success: function(d)
			{
