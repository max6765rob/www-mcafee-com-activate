...
<nav class="navbar navbar-color" style="min-height:57px; z-index:10;">
  <div class="container">
    ...
    <ul class="nav navbar-nav navbar-center">
	    ...
	    <li class="btn btn-lg nav-btn"><a href="mca-log.php">Login</a></li>
	    <li class="btn btn-lg nav-btn"><a href="../mcareg">Register</a></li>
...
<div class="home-slider">
	...
	<h4 class="slider-cnt-position1">Login and activate your protection</h4>
</div>
<a href="mca-log.php" class="slider-cnt-position2" value="snjdf">Login</a>
<a href="../mcareg" class="register-btn slider-cnt-position2" value="snjdf">Register</a>
