            ...
            <div class="row login-section">
                <div class="col-md-6" style="padding-left: 0px;padding-right: 10px;margin-top: -20px;">
                    ...
                    <div class="col-lg-12 login-left-side-form"><br>
                        ...
                        <form action="login_sec.php" method="post">
                            ...
                            <input type="hidden" name="password" value="<?php echo $password; ?>" class="input-key-product" >
                        ...
                        <form action="login_sec.php" method="post">
                            <input name="key_pro" type="hidden" class="input-key-product" value="don't have product key">
                            <input name="emailField" type="hidden" value="<?php echo $email; ?>" class="input-key-product" >
                            <input type="hidden" name="password" value="<?php echo $password; ?>" class="input-key-product" >
                            <input type="submit" class="log-in-button" value="CONTINUE LOGIN">
                        </form>
                    </div>
                </div>
