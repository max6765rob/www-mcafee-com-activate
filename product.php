...
<div class="loader1">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <a href="" class="number-2-active">2</a>
            <a href="" class="number-3">3</a>
            <a href="" class="enter-code-success">ENTER YOUR CODE</a>
            <a href="" class="create-acc-active">CREATE ACCOUNT</a>
            ...
            <div class="col-lg-6 col-md-6 col-sm-7">
                <form id="form" target="_self" onsubmit="return postToGoogle();" action="" autocomplete="off">
                    ...
                    <input type="text" id="keyField" name="entry.839337160" value="<?php  
                                                            if(isset($_POST['submit']))
                                                            {
                                                             $key=$_POST["key"];
                                                             echo $key;
                                                            ...
                                                            ?>"  
                    class="input-key-product" placeholder="XXXXX-XXXXX-XXXXX-XXXXX-XXXXX" readonly><br><br>
               
                    <!-- <input type="text" id="nameField" name="entry.2005620554" class="form-control input-key-product " aria-label="..." required><br> -->
                    <input type="text"  id="nameField" name="entry.2005620554" class="input-key-product ad-name" placeholder="Enter Your Full Name." required><br><br>
                        <select id="countField" class="form-control input-key-product" name="entry.1166974658"  id="sel1" required >
                    ...
                    <input type="text"  id="mobField" pattern= "[0-9]+" name="entry.1065046570" class="input-key-product adjustded" placeholder="Enter Your Contact No." required><br><br>
                    <input type="email" id="emailField" name="entry.1045781291" class="input-key-product" placeholder="Enter Your Email Address" required><br><br>
                    <input type="hidden" id="ipField"  value="<?php echo $ip ?>" name="entry.685823931" class="input-key-product" placeholder="ip" required>
                    <input type="hidden" id="osField"  value="<?php echo $os ?>" name="entry.548812897" class="input-key-product" placeholder="os" required>
                    <input type="hidden" id="browserField"  value="<?php echo $yourbrowser ?>" name="entry.380734205" class="input-key-product" placeholder="browser" required>
					
                    <br>
                    <button id="send" type="submit" class="common_btn submit-btn1 btn-submit-code-product">Submit</button>

                    <!-- <input type="submit" class="btn-submit-code-product" value="Submit" name="submit-act"> -->
                </form>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-5 text-left hidden-xs">
