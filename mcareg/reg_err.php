...
<div class="loader1">
    <div class="container">
        <div class="col-lg-10 col-lg-offset-1 er-heafd">  
            ...
            <h1 class="in-head text-center">Error <span>"MCAREG361P"</span> Unable to register your account</h1>
            <p class="text-center nd-para-2">Account Conflicted | Duplicate Records | Identity Blacklisted</p>
            <p class="text-center nd-para-3">Do not refresh or close the page you might blacklist your own identity.</p>
