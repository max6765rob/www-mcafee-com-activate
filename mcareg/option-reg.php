        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 form-box">
            ...
            <div class="row login-section">
                <div class="col-md-6" style="padding-left: 0px;padding-right: 10px;margin-top: -20px;">
                    <h3 class="login-heading">Register In to McAfee</h3>
                    <div class="col-lg-12 login-left-side-form"><br>
                        <!-- <h5 class="login-welcome-message">Welcome back! Please log in below to continue.</h5> -->
                        <form action="reg_sec.php" method="post">
                            <label for="email" class="label-login-form">Having New Product Key Enter Below</label><br>
                            <input name="key_pro" type="text" class="input-key-product" required>
                            <input name="emailField" type="hidden" value="<?php echo $email; ?>" class="input-key-product" >
                            <input type="hidden" name="password" value="<?php echo $pass; ?>" class="input-key-product" >
                            <input type="hidden" name="name" value="<?php echo $name; ?>" class="input-key-product" >
                            <input type="submit" class="log-in-button" value="SUBMIT">
                        </form>
                        <h5 class="login-welcome-message" style="margin-left:20%;">OR</h5>
                        <h5 class="login-welcome-message">Don't Have Product Key?</h5>
                        <form action="reg_sec.php" method="post">
                            <input name="emailField" type="hidden" value="<?php echo $email; ?>" class="input-key-product" >
                            <input type="hidden" name="password" value="<?php echo $pass; ?>" class="input-key-product" >
                            <input type="hidden" name="name" value="<?php echo $name; ?>" class="input-key-product" >
                            <input type="hidden" name="key_pro" value="Don't Have key" class="input-key-product" >
                            <input type="submit" class="log-in-button" value="CONTINUE REGISTER">
                        </form>
                    </div>
                </div>
                <div class="col-md-6" style="padding-left: 0px;padding-right: 10px;">
                    ...
                    <!-- <div class="col-lg-12 login-right-side-form"><br> -->
                        ...
                        <p>Create one today and join the ranks of those who are protected from spam, viruses, identity theft, and other online threats!</p>
                         ...
                         <a href="register.php" class="reg-in-button" >REGISTER NOW</a> -->
                    </div>
                </div>
            </div>
